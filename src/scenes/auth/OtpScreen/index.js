           ...
           <View style={{flex:0.8}}>
            ...
            <View>
                ...
                <View style={styles.headingWrapper}>
                    ...
                    <Text style={styles.headingTextWrapper}>Please enter the OTP sent to {'\n'} your mobile number.</Text>

                </View>
                <OTPInputView
                style={{width: '60%', height: 50,alignSelf:'center',marginTop:hp(6)}}
                pinCount={4}
            ...
            <TouchableOpacity onPress={() => props.navigation.navigate('Home')} style={styles.otpWrapper}>
...
const styles = StyleSheet.create({
    ...
    inboxText:{ fontSize: 22, fontFamily: MONTSERRAT_BOLD, color: '#9066e6', textAlign: 'center' },
    headingWrapper: { marginTop: hp(2), marginHorizontal: wp(5), },
    headingTextWrapper: { fontSize: 16, fontFamily: MONTSERRAT_MEDIUM, color: '#000', textAlign: 'center', lineHeight: 25 },
    underlineStyleBase: {
        width: 45,
        height: 45,
        borderWidth: 0,
    ...
    otpNotText:{fontSize: 18, fontFamily: MONTSERRAT_MEDIUM, color: BLACK, textAlign: 'center' },
    resentTextWrapper:{fontSize: 15, fontFamily: MONTSERRAT_MEDIUM, color: '#c2c2c2', textAlign: 'center',marginTop:hp(1) },
    otpWrapper: { paddingVertical: hp(2), backgroundColor: '#9066e6', width: wp(65), alignSelf: 'center', justifyContent: 'center', alignItems: 'center', marginVertical: hp(2) },
