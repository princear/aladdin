            ...
            <View style={styles.headerWrapper}>
                <View style={styles.headerAligner}>
                    <TouchableOpacity onPress={() => { navigation.goBack() }}>
                        <Image source={require( '../../../assets/images/backwhitecolour.png' )} style={styles.headerLeftImage} />
                    </TouchableOpacity>
                    <Text style={styles.headerCenterText}>{t('placeholders.bookingList.booking')}</Text>
                </View>
            </View>
            {( loading ) &&
                            ...
                            <>
                                <TouchableOpacity
                                    ...
                                    <View style={[styles.approvedWrapper, {
                                        backgroundColor: item.status === 'Pending' ? '#f2ac00' :
                                            item.status == 'Cancelled' ? '#da3348' :
                                                item.status == 'Completed' ? '#2ea749' :
                                                    item.status == 'Approved' ? '#157dfc' :
                                                        item.status == 'In Progress' ? '#157dfc' : null
                                    }]}>
