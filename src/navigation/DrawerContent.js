...
import { Alert, ActivityIndicator, StyleSheet, View, Text, Image, TouchableOpacity } from 'react-native';
  ...
  return (
    <View style={styles.drawerContainer}>
      ...
      <DrawerContentScrollView {...props}>
        ...
        <TouchableOpacity style={[styles.bookingWrapper, { backgroundColor: active === 'Bookings' ? '#9066e6' : '#fff' }]}
          onPress={() => bookingBack()}
        >
          <View style={{ flexDirection: 'row', alignItems: 'center' }}>
        ...
        <TouchableOpacity style={[styles.bookingWrapper, { backgroundColor: active === 'Profile' ? '#9066e6' : '#fff' }]}
          onPress={() => profileBack()}
        >
          <View style={{ flexDirection: 'row', alignItems: 'center' }}>
        ...
        <TouchableOpacity style={[styles.bookingWrapper, { backgroundColor: active === 'Language' ? '#9066e6' : '#fff' }]}
